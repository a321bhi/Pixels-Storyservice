...
public class PixelSenseUser implements Serializable {
	...
	private Set<MediaOracle> mediaList = new HashSet<>();

	@ManyToMany(mappedBy = "likedBy")
	@JsonProperty(access = JsonProperty.Access.WRITE_ONLY)
	private Set<MediaOracle> likedMedia = new HashSet<>();
	...
	public Set<MediaOracle> getMediaList() {
		return mediaList;
	}
	...
	public Set<MediaOracle> getLikedMedia() {
		return likedMedia;
	}
